...
(function () {
  ...
  // Derive the site base ('' at the web root, '/raku-books' under a sub-path)
  // from a known asset link, so the index fetch works wherever the site is hosted.
  var SITE_BASE = (function () {
    var el = document.querySelector('link[href*="/assets/course.css"]')
          || document.querySelector('script[src*="/assets/search.js"]');
    if (el) {
  ...
  var INDEX_URL = SITE_BASE + '/search-index.json';
